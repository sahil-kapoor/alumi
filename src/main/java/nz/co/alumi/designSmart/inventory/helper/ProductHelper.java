...
public class ProductHelper {
  ...
  public boolean completeMatch(Integer width,Integer height,String color, String openSide, Product product){
  ...
  public boolean partialMatchWithHeightColorOpenSide(Integer height,String color, String openSide,Product product){
    return (compareIntegers.apply(height,product.getSizeH()) &&
        compareStrings.apply(color,product.getColorKey()) &&
        compareStrings.apply(openSide,product.getOpenSideKey()));
  }

  public boolean partialMatchWithWidthColorOpenSide(Integer width,String color, String openSide,Product product){
    return (compareIntegers.apply(width,product.getSizeW()) &&
        compareStrings.apply(color,product.getColorKey()) &&
        compareStrings.apply(openSide,product.getOpenSideKey()));
  }
  ...
  public BiFunction<Integer, Integer, Boolean> compareIntegers = (x1, x2) -> x1!=null && x2!=null && x1.equals(x2);
  public BiFunction<String, String, Boolean> compareStrings = (x1, x2) -> x1!=null && x2!=null && x1.equalsIgnoreCase(x2);
